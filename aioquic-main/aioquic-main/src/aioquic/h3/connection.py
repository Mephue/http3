...
def encode_settings(settings: Dict[int, int], cap: int) -> bytes:
...
class H3Connection:
    ...
    def __init__(self, quic: QuicConnection,  cap_buffer: int, enable_webtransport: bool = False) -> None:
        # attack setting
        self._cap_buffer = cap_buffer
